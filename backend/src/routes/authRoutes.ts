...
// Auto-servicio: el usuario confirma que ya cambió su propia contraseña temporal
// (vigente o vencida — requireAuth la permite explícitamente en ambos casos,
// ver RUTAS_PERMITIDAS_CON_PASSWORD_VENCIDA en middleware/auth.ts).
router.post('/auth/password-changed', requireAuth, (req, res) => controller.passwordChanged(req, res));

...
export const generarPlantilla = async (
  ...
  const rows: Array<[string, string]> = [
    ...
    ['Alcance', 'No usar ASIGNACION para definir alcance: las relaciones de estas hojas alimentan directamente a Usuarios/Grupos y Niveles/ScopeService. NOMBRE_CARTERA NO necesita existir en cartera.gestor (dato operativo, no fuente de identidad). La cartera solo se usa para validar que los pares País/Zona de GESTOR_PAIS_ZONA/GERENTE_PAIS_ZONA existan realmente.'],

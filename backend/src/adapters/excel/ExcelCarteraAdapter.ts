...
/**
 * Fuente de datos basada en el archivo local "CARTERA COBRO.xlsx" (hoja ASIGNACION).
...
export class ExcelCarteraAdapter implements CarteraDataSource {
  ...
  private readonly fileName = 'CARTERA COBRO.xlsx';
  private readonly sheetName = 'ASIGNACION';
